...
from .models import Person, meta_default_value, get_next_internal_id
...
class PeopleBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Person(meta=meta_data, **item))

        return Person.objects.bulk_create(object_data)
...
class PersonSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        instance = Person.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = PeopleBulkSerializer
